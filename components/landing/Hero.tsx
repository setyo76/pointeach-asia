...
function MockupCard() {
  ...
  return (
    <motion.div
      ...
      transition={{ duration: 0.9, ease: [0, 0, 0.2, 1], delay: 0.3 }}
    >
      <motion.div
        animate={{ y: [-10, 10, -10] }}
        ...
        whileHover={{
          scale: 1.02,
          boxShadow: '0 32px 80px -12px rgba(99,102,241,0.25), 0 8px 32px -8px rgba(15,23,42,0.12)',
        }}
    ...
    <section className='relative overflow-hidden bg-gradient-to-b from-white via-slate-100 to-slate-50 py-24'>
      <div className='mx-auto grid max-w-7xl gap-12 px-6 lg:grid-cols-2 lg:items-center'>
        ...
        >
          ...
          >
            <WaveLink href='#features' primary className='px-8 py-3.5 active:scale-95'>
              {t.ctaPrimary}
            </WaveLink>
